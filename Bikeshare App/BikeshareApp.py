...
class Bikeshare:
    def __init__(self, master):
        ...
        def continue1():
            ...
            def choice():
                ...
                def question():
                    ...
                    self.info_frame = Frame(self.master,bg='#7e7e7e',bd=1,relief='ridge')
                    self.info_frame.place(x=290,y=50,width=440,height=110)
                    self.info_5a = Label(self.info_frame,text=text1,font=('normal',9,'bold'),bg='#7e7e7e',fg='#000000').place(x=5,y=2)
                    self.info_5b = Label(self.info_frame,text=text2,font=('normal',9),bg='#7e7e7e',fg='#000000').place(x=5,y=20)
                    self.info_5c = Label(self.info_frame,text=text3,font=('normal',9),bg='#7e7e7e',fg='#000000').place(x=5,y=40)
                    self.info_5d = Label(self.info_frame,text=text4,font=('normal',9),bg='#7e7e7e',fg='#000000').place(x=5,y=60)
                    self.info_5e = Label(self.info_frame,text=text5,font=('normal',9),bg='#7e7e7e',fg='#000000').place(x=5,y=80)
                    def delete():
                        self.question_btn.place(x=416,y=15)
                        self.info_frame.place_forget()
                    self.delete = Button(self.info_frame,text='x',font=('normal',10,'bold'),bg='#7e7e7e',bd=0,relief='flat',fg='red',activebackground='#7e7e7e',command=delete).place(x=420,y=0)
                    
                self.question_btn = Button(self.master,text='?',font=('normal',9,'bold'),fg='#7e7e7e',activebackground=background,bd=0,relief='flat',bg=background,command=question)
                self.question_btn.place(x=416,y=15)
                def check_box():
                    if m.get() == 1:
                ...
                self.continue_btn2 = Button(self.master,text='Continue',font=('arial',12),bg='#afc3df',fg=background,bd=1,relief='ridge',activebackground=background,command=continue2)
        ...
        self.continue_btn = Button(self.master,text='Continue',font=('arial',12),bg='#afc3df',fg=background,bd=1,relief='ridge',activebackground=background,command=continue1)
